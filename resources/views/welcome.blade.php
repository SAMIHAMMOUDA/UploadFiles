...
<div class="relative flex items-top justify-center m-3 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ route('dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Files</a>
            @else
    ...
    <div class="container bg-white">
         <section>
            <div class="row">
              <div class="col-6 align-self-center">
               <h1> Upload, share and manage your files for free. </h1>
               <a href="{{ route('login') }}" class="btn btn-outline-primary m-3 btn-lg">LOGIN »</a>

               {{-- <button class="btn btn-primary type-uppercase "> Upload </button> --}}
              </div>
              <div class="col-6">
         ...
         <section>
            <div class="text-center m-5  p-5 bg-light">
                <h2 class="p-3">Store and manage all your files !</h2>
                <p class="lead">
        ...
        <div class="container bg-white">
            <section class="m-5">
               <div class="row">
                 ...
                 <div class="col-6">
                   <img src="images/ban.png " class="img-fluid" alt="home">
                 </div>
               </div>
           </section>
       </div>
     ...
     <div class="container bg-white">
        <section class="text-center">
            <div class="row">
                <div class="col-md-6 card text-dark bg-light p-5">
    ...
    <div class="card-footer mt-5 p-4">
         footer
      </div>
